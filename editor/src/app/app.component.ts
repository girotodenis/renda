...
export class AppComponent implements OnInit {
  ...
  init: EditorComponent['init'] = {
    ...
    selector:'#idEditor',
    inline: false, // Ativa o modo inline (sem iframe)
  ...
  //font_size_formats: '10px 12px 13px 14px 16px 18px 24px 32px 48px 96px', // Define os tamanhos em px
    ...
    plugins: 'a4pages variaveisMesclagem fullscreen codesample insertdatetime advlist media lists autoresize save searchreplace nonbreaking link image charmap preview anchor pagebreak visualblocks visualchars code table directionality help',
    external_plugins: {
